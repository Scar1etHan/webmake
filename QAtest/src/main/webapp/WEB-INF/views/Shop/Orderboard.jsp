		...
		<div class="row">
			<div class="col-md-2 sidebar">
				<ul class="nav flex-column">
					...
					<li class="nav-item"><a class="nav-link" href="../Member/MemberInfo.jsp">회원정보</a>
						<hr></li>
					<li class="nav-item"><a class="nav-link" href="../Member/MemberModiInfo.jsp">회원수정</a>
						<hr></li>
					<li class="nav-item"><a class="nav-link" href="Orderboard.jsp">주문목록</a>
						<hr></li>
					<li class="nav-item"><a class="nav-link" href="#">회원탈퇴</a>
						<hr></li>
				</ul>
			</div>
