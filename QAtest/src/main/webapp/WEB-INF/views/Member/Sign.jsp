                ...
                <form name="sign" class="validation-form" novalidate method="post" action="${path}/Member/insert">
                    ...
                    <div class="row">
                       ...
                       <div class="col-md-3 offset-md-1 mb-3">
                            ...
                            <select id="user_sex" name="user_sex" class="form-control" required">
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            ...
                            <div class="input-group">
					            <input type="text" class="form-control mb-3" id="user_Addr1" name="user_Addr1" 
                            ...
                            <input type="text" class="form-control mb-3" id="user_Addr2" name="user_Addr2" 
...
<script>
    ...
    //	이벤트 리스너 (이름)
    document.getElementById("user_name").addEventListener("input", checkNameValid);
    ...
    //	이벤트 리스너 (나이)
    document.getElementById("user_age").addEventListener("input", checkAgeValid);
    
    // 유효성 체크 (성별)
    function checkSexValid(){
    	const userSex = document.getElementById("user_sex");
    ...
    //	이벤트 리스너 (성별)
    document.getElementById("user_sex").addEventListener("change", checkSexValid);
    ...
    //	이벤트 리스너 (이메일)
    document.getElementById("user_email").addEventListener("input", checkEmailValid);
    ...
    //	이벤트 리스너 (전화번호)
    document.getElementById("user_phone").addEventListener("input", checkPhoneValid);
...
<script>
    ...
    document.getElementById("user_pw").addEventListener("input", checkPasswordMatch);
