...
.container {
            padding-top: 100px; /* 상단 메뉴 높이만큼 여백 추가 */
        }
...
<body>
	...
	<div class="container mt-5" style="background-color: white;">
		...
		<h2 style="padding-top:100px">회원가입 약관 동의</h2>
		<div>
			<div class="form-check">
				<input class="form-check-input" type="checkbox" id="checkbox1"
					onchange="toggleSubmitButton()"> <label
					class="form-check-label custom-label" for="checkbox1"> [필수]CUSTOMIZED COSMETICS계정 약관 </label>
				<div class="terms-container">
					<textarea class="form-control custom-textarea" rows="4" readonly>
인터넷 쇼핑몰 『CUSTOMIZED COSMETICS 사이버 몰』회원 약관

제1조(목적)
이 약관은 CUSTOMIZED COSMETICS 회사(전자상거래 사업자)가 운영하는 CUSTOMIZED COSMETICS 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.

  ※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다.」

제2조(정의)
① “몰”이란 CUSTOMIZED COSMETICS 회사가 재화 또는 용역(이하 “재화 등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
...
① “몰”은 이 약관의 내용과 상호 및 대표자 성명, 영업소 소재지 주소(소비자의 불만을 처리할 수 있는 곳의 주소를 포함), 전화번호·모사전송번호·전자우편주소, 사업자등록번호, 통신판매업 신고번호, 개인정보보호책임자 등을 이용자가 쉽게 알 수 있도록 CUSTOMIZED COSMETICS 사이버몰의 초기 서비스화면(전면)에 게시합니다. 다만, 약관의 내용은 이용자가 연결화면을 통하여 볼 수 있도록 할 수 있습니다.
...
본 약관은 2023년 08월 18일부터 적용됩니다.
			...
			<div class="form-check">
				<input class="form-check-input" type="checkbox" id="checkbox2"
					...
					<label class="form-check-label custom-label" for="checkbox2"> 
						[필수]개인정보 수집 및 이용
					</label>
				<div class="terms-container">
					<textarea class="form-control custom-textarea" rows="4" readonly>
...
이용자는 개인정보의 수집 및 이용 동의를 거부할 권리가 있습니다. 회원가입 시 수집하는 최소한의 개인정보, 즉, 필수 항목에 대한 수집 및 이용 동의를 거부하실 경우, 회원가입이 어려울 수 있습니다.
			...
			<div class="form-check">
				<input class="form-check-input" type="checkbox" id="checkbox3"
					onchange="toggleSubmitButton()"> <label
					class="form-check-label custom-label" for="checkbox3">
					[선택] 이벤트 혜택 정보 수신 </label>
				<div class="terms-container">
					<textarea class="form-control custom-textarea" rows="4" readonly>
CUSTOMIZED COSMETICS 서비스 및 제휴 이벤트・혜택 등의 정보를 휴대전화(알림 또는 문자), 이메일로 받을 수 있습니다. 
일부 서비스(별개의 회원 체계 운영, CUSTOMIZED COSMETICS 가입 후 추가 가입하는 서비스 등)의 경우, 
수신에 대해 별도로 안내드리며 동의를 구합니다.
                </textarea>
				</div>
			</div>
			<div class="text-center mt-3" style="padding-bottom: 20px;">
				...
				<button type="button" id="submit-button"
					class="btn btn-success ml-2" onclick="submitForm()" disabled>회원가입</button>
			</div>
		</div>
	</div>
	<!-- 하단 영역(footer) -->
	...
	<script>
    // JavaScript 코드 체크박스 2개 눌러야 회원가입 버튼 활성화
