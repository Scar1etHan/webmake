...
<title>피부진단</title>
	...
	<link href="../../../resources/css/Vote.css?v=<%=System.currentTimeMillis() %>" rel="stylesheet">
...
<div class="p-5 "></div><div class="p-5 "></div>
	<div class = "container"> <!-- 중앙 묶음 -->
	
	
	
	  <!-- <div class="p-1 "></div> 여백
	   <div class="p-5 "></div>
	
  		<div class = "row"> 로고
			<div>
			<a class="dropdown-item" href="index.jsp">
				<img src="./images/Logo2.png" class="img-fluid w-25  offset-md-5" alt="...">문제점 : 수평여백 맞추기
			</a>
			</div>
		</div>
 ...
 <!--  <nav class="navbar navbar-expand-lg bg-light"> 상단바
  <div class="container-fluid">
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item dropdown">   묶음버튼
          ...
          <ul class="dropdown-menu">
            ...
            <li><a class="dropdown-item" href="#">이벤트게시판</a></li>
            <li><hr class="dropdown-divider"></li> 분단선
        ...
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="Vote.jsp">피부진단</a> 피부진단 
        </li>
		...
		<div class="col-sm-12">
			<div class="mm-survey">
				...
				<div class="mm-survey-progress">
					<div class="mm-survey-progress-bar mm-progress"></div> <!-- 검사 진행도 바 -->
				</div>

				<div class="mm-survey-results">
					<div class="mm-survey-results-container"> <!-- 결과 컨테이너 -->
						<h3 class="mm-survey-results-score"></h3> <!-- 당신의 피부타입은 ~ -->
						<hr>
						<!-- <ul class="mm-survey-results-list"></ul> --> <!-- 타입 바 -->
						
						<div class="p-3 "></div> <!-- 여백  -->
						
						<section class="bar-graph bar-graph-horizontal bar-graph-one"> <!-- 바 그래프 -->
						  <div class="bar-one"><!-- 1번바 -->
						    <span class="type">유수분 밸런스</span>
						    <div class="mm-survey-results-type1"></div>
						  </div>
						  <div class="bar-two"><!-- 2번바 -->
						    <span class="type">피부 민감도</span>
						    <div class="mm-survey-results-type2"></div>
						  </div>
						  <div class="bar-three"><!-- 3번바  -->
						    <span class="type">색소 활성도</span>
						    <div class="mm-survey-results-type3"></div>
						  </div>
						  <div class="bar-four"><!-- 4번바 -->
						    <span class="type">피부 탄력도</span>
						    <div class="mm-survey-results-type4"></div>
						  </div>
						</section>
					</div>
<!-- 					<div class="mm-survey-results-controller">
				...
				<div class="mm-survey-results2"> <!-- hide -->
					<div class="mm-survey-results2-container"> <!-- 결과 컨테이너 -->
						<!-- <h3 class="mm-survey-results2-score"></h3> 타입 -->
						...
						<div class="row gx-4 gx-lg-5 align-items-center my-5">
							<!-- <div class="col-lg-1"></div> -->
               				<div class="col-lg-11" >
               				<center>
                				<ul class="mm-survey-results-picture"></ul> <!-- 사진 -->
                			</center>
						    </div>
						    <div class="col-lg-1"></div>
                			...
                			<div class="col-lg-8">
                    			...
                    			<ul class="mm-survey-results2-list2"></ul>
                    			</center>
                   			</div>	
                   			<div class="col-lg-2"></div>
			            ...
			            <div>
			                ...
			                <h2 >맞춤상품</h2>
			                <div>
			                	<!-- <img src="../resources/images/사진2.PNG" width="600" hight="900" class="radius_Img border_Img" > -->
			                	<div class="mm-survey-results-picture2"></div>	
		                    <p class="product-text">
                             	<p>
                             	<a class="mm-survey-results-button"></a>
...
<!-- 			             <div class="row gx-4 gx-lg-5">
			            ...
			            <div class="card text-white bg-secondary my-5 py-4 text-center">
                			<div class="card-body"><p id="quotation"></p><p id="source"></p></div>
            			</div>
            			<div class="col-lg-4"></div>
            			<div>
	            			<img class="moveImg" src="../resources/images/사진9.PNG">
							<img class="moveImg" src="../resources/images/사진10.PNG" style="--f:.12;--r:5px">
							<img class="moveImg" src="../resources/images/사진11.PNG" style="--f:.08;--r:20px">
						</div>
				...
				<div class="mm-survey-bottom"> <!-- 질의응답 칸 -->
					<div class="mm-survey-container">
						...
						<div class="mm-survey-page" data-page="9">
							<div class="mm-survery-content">
								...
								<div class="mm-survey-item">
									<input type="radio" id="radio37" data-item="9" name="radio9" value="1" />
									<label for="radio37"><span></span><p>1.항상 그렇습니다.</p></label>
								</div>
								<div class="mm-survey-item">
									<input type="radio" id="radio38" data-item="9" name="radio9" value="2" />
									<label for="radio38"><span></span><p>2.때때로 그렇습니다.</p></label>
								</div>
								<div class="mm-survey-item">
									<input type="radio" id="radio39" data-item="9" name="radio9" value="3" />
									<label for="radio39"><span></span><p>3.거의 그렇지 않습니다.</p></label>
								</div>
								<div class="mm-survey-item">
									<input type="radio" id="radio40" data-item="9" name="radio9" value="4" />
...
<script async src="../resources/js/Vote.js?v=<%=System.currentTimeMillis() %>"></script>
