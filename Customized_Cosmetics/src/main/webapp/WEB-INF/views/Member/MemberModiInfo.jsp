						...
						<form class="validation-form" action="MemberModiInfo" method="POST" novalidate>
							...
							<div class="row">
								<div class="col-md-6 mb-3">
									...
									<input type="text" class="form-control" id="userName" name="userName" value="${updateMember.userName}" readonly>
								</div>
							</div>
							<hr>
							...
							<div class="row">
								<div class="col-md-6 mb-3">
									...
									<input type="text" class="form-control" id="userAge" name="userAge" value="${updateMember.userAge}" readonly>
								</div>
							</div>
							<hr>
							...
							<div class="row">
								<div class="col-md-6 mb-3">
									...
									<input type="text" class="form-control" id="userSex" name="userSex" value="${updateMember.userSex}" readonly>
								</div>
							</div>
							<hr>
							...
							<div class="row">
								<div class="col-md-6 mb-3">
									...
									<input type="text" class="form-control" id="userId" name="userId" value="${updateMember.userId}" readonly>
								</div>
							</div>
							<hr>
							...
							<div class="row">
								<div class="col-md-6 mb-3">
									...
									<input type="text" class="form-control" id="userCell" name="userCell" placeholder="전화번호" value="${updateMember.userCell}" required>
								</div>
							</div>
							<hr>
							...
							<div class="row">
								<div class="col-md-6 mb-3">
									...
									<input type="email" class="form-control" id="userEmail" name="userEmail" placeholder="your@email.com" value="${updateMember.userEmail}" required>
								</div>
							</div>
							<hr>
							...
							<div class="row">
								<div class="col-md-12 mb-3">
									...
									<div class="input-group">
										<input type="text" class="form-control mb-3" id="userAddr1" name="userAddr1" value="${updateMember.userAddr1}" placeholder="우편번호" size="10" required readonly> 
										<input type="button" class="btn btn-outline-primary" onclick="findAddr()" value="우편번호 찾기" style="margin-left: 5px;">
									</div>
									<input type="text" class="form-control mb-3" id="userAddr2"
										   name="userAddr2" value="${updateMember.userAddr2}" placeholder="도로명주소"
									...
									<input type="text" class="form-control mb-3" id="userAddr3" name="userAddr3"
										 	value="${updateMember.userAddr3}" placeholder="상세주소" size="60" required>
							...
							<hr class="mb-4">
							<button type="submit" class="btn btn-primary btn-lg btn-block" onclick="memberModi()">회원정보 변경</button>
